...
export function PatientList({ patients, totalCount, activeCount }: PatientListProps) {
  ...
  const formatAddress = (patient: Patient) => {
    const parts = [patient.address, patient.city, patient.state].filter(Boolean);
                    ...
                    <tr key={patient.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4 hidden lg:table-cell">
                        <div>
                          ...
                          <p className="text-xs text-slate-400">{patient.phone || 'N/A'}</p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
